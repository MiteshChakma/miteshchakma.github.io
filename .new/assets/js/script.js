const TYPEWRITER_STRINGS = [
    ...
    "Backend systems for data platforms",
    "LLM evaluation & AI data workflows",
...
function initTypewriter() {
    ...
    const tick = () => {
        const phrase = TYPEWRITER_STRINGS[phraseIndex];
        ...
        deleting = false;
        phraseIndex = (phraseIndex + 1) % TYPEWRITER_STRINGS.length;
...
function refreshProjectPanels() {
    ...
    tabs.forEach((tab) => {
        ...
        if (sorted.length === 0) {
            grid.innerHTML = `<p class="projects-empty panel-soft">No projects in this category yet. Add items in HTML or pin repos in your GitHub README.</p>`;
            return;
        }
